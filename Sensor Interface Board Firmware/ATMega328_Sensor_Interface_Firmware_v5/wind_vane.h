...
class wind_vane_array_ {
  public:
    ...
    bool      vane_training_mode = false;        // This flag sets if we are in vane training mode or not....
    int       vane_training_direction = 0;        // This is used for the vane training mode
    // Functions:
    void begin(bool my_debug);
...
extern wind_vane_array_ wind_vane_data;
