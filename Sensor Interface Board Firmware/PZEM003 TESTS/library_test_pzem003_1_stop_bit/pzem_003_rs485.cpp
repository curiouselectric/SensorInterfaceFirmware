...
// End of debug
  ...
  switch (dataType) {
    ...
    case 'a':
      ...
      dcPower_Int = 0;
      dcPower_Int = dcPower_Int + long(pzem003Response[7]);
      dcPower_Int << 8;
      dcPower_Int = dcPower_Int + long(pzem003Response[8]);
      dcPower_Int << 8;
      dcPower_Int = dcPower_Int + long(pzem003Response[9]);
      dcPower_Int << 8;
      dcPower_Int = dcPower_Int + long(pzem003Response[10]);
      dcPower = ((float)dcPower_Int / 10.0);
      dcEnergy_Int = 0;
      dcEnergy_Int = dcEnergy_Int + long(pzem003Response[11]);
      dcEnergy_Int << 8;
      dcEnergy_Int = dcEnergy_Int + long(pzem003Response[12]);
      dcEnergy_Int << 8;
      dcEnergy_Int = dcEnergy_Int + long(pzem003Response[13]);
      dcEnergy_Int << 8;
      dcEnergy_Int = dcEnergy_Int + long(pzem003Response[14]);
      dcEnergy = ((float)dcEnergy_Int);
      break;
  }
  return true;
